...
def engineer_features(Va, Vb, Vc):
    """
...
best_val_acc, patience_count, PATIENCE = 0.0, 0, 20
...
print("\n── Test Set Results ──")
print(classification_report(y_test, preds, target_names=["Healthy", "Faulted"]))
